...
if __name__ == '__main__':
    ...
    data_dir = 'C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/train_data'

    tra_image_dir = 'DUTS-TR/DUTS-TR-Image'
    tra_label_dir = 'DUTS-TR/DUTS-TR-Mask'

    image_ext = '.jpg'
    label_ext = 'Caracalla.png'

    model_dir = "C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/saved_models/basnet_bsi"
    ...
    tra_img_name_list =  os.listdir("C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/train_data/DUTS-TR/DUTS-TR-Image")
    tra_img_name_list = [ "C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/train_data/DUTS-TR/DUTS-TR-Image"
                          +"/"
                          + tra_img_name_list[i] for i in range(len(tra_img_name_list))]



    tra_lbl_name_list = os.listdir("C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/train_data/DUTS-TR/DUTS-TR-Mask")
    tra_lbl_name_list = ["C:/Users/nehdi/PycharmProjects/PCD/DeepLearningMethodForSegmentation/train_data/DUTS-TR/DUTS-TR-Mask"
                         +"/"
                         +tra_lbl_name_list[i] for i in range(len(tra_lbl_name_list))]
